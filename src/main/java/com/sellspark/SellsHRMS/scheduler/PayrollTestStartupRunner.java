...
// log.info("🕑 Running test payroll for org ID {} on startup (date: {})",
// TEST_ORG_ID, today);
...
// Optional<OrganisationPolicy> policyOpt =
// policyRepository.findByOrganisationId(TEST_ORG_ID);
...
// log.info("🗑️ Deleting existing PayRuns for org {} [{} - {}]", org.getName(),
// cycleStart, cycleEnd);
// payRunRepository.findByOrganisation_IdAndStartDateAndEndDate(TEST_ORG_ID,
// cycleStart, cycleEnd)
// .ifPresent(payRun -> {
// // payrollService.deletePayRun(payRun.getId()); // make sure your service can
// // handle deleting slips
...
// log.info("▶️ Running payroll for org {} [{} - {}]", org.getName(),
// cycleStart, cycleEnd);
...
// log.info("✅ Test payroll completed for org {} [{} - {}]", org.getName(),
// cycleStart, cycleEnd);

// Map<String, Object> basectx = new HashMap<>();
// basectx.put("BASE", 30000.0);
// System.out.println(FormulaExpressionEvaluator.evaluate("BASE * 0.12",
// basectx));
// log.info("base context {}", basectx);

// }

// private LocalDate[] calculateCycleDates(LocalDate today, OrganisationPolicy
// policy) {
// Integer startDay =
// Optional.ofNullable(policy.getSalaryCycleStartDay()).orElse(1);
