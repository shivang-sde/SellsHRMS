...
//     private final com.sellspark.SellsHRMS.repository.EmployeeRepository employeeRepository;
...
//             .forEach(org -> {
//                 long count = summaryRepo.countByOrganisationIdAndAttendanceDate(org.getId(), today);

//                 if (count == 0) {
//                     log.warn("⚠️ No attendance summaries found for org: {} (ID: {}). Running preMarkDailyAttendance...", 
//                              org.getName(), org.getId());
//                     try {
//                         scheduler.preMarkDailyAttendance();
//                         log.info("✅ Attendance pre-mark completed for org: {}", org.getName());
//                     } catch (Exception e) {
//                         log.error("❌ Failed to pre-mark attendance for org {}: {}", org.getName(), e.getMessage());
//                     }
//                 } else {
//                     log.info("✅ Attendance already exists for org: {} ({} records)", org.getName(), count);
//                 }
//             });
