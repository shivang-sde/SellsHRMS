...
// String errorMsg = "SUPER_ADMIN_PASSWORD environment variable must be set in
// production!";
// log.error(errorMsg);
...
// log.warn(
// "⚠️ Using default test password for super admin. Set SUPER_ADMIN_PASSWORD in
// .env to override.");
// }
// }
...
// log.info("✅ Super admin created with email: {} and role: SUPER_ADMIN",
// superAdminEmail);
// }
