...
public class TaskServiceImpl implements TaskService {
    ...
    public TaskDTO updateTask(Long taskId,
        ...
        if (removeAttachmentIds != null && !removeAttachmentIds.isEmpty()) {
            ...
            toDelete.forEach(a -> logActivity(task, employeeId, TaskActivity.ActivityType.ATTACHMENT_REMOVED,
                    a.getFileName(), null));
        }
    ...
    public List<TaskAttachmentDTO> addAttachments(Long taskId, List<TaskAttachmentDTO> dtos, Long employeeId) {
        ...
        attachments.forEach(a -> logActivity(task, employeeId, TaskActivity.ActivityType.ATTACHMENT_UPLOADED, null,
                a.getFileName()));
