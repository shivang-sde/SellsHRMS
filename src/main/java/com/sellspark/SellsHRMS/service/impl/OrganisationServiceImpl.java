...
public class OrganisationServiceImpl implements OrganisationService {
    ...
    private OrganisationDTO toDto(Organisation org, OrganisationAdmin admin) {
        return OrganisationDTO.builder()
                ...
                .tan(org.getTan())
                .gst(org.getGst())
                .aadhar(org.getAadhar() != null ? org.getAadhar() : "")
                .panUrl(org.getPanUrl() != null ? org.getPanUrl() : "")
                .tanUrl(org.getTanUrl() != null ? org.getTanUrl() : "")
                .gstUrl(org.getGstUrl() != null ? org.getGstUrl() : "")
                .aadharUrl(org.getAadharUrl() != null ? org.getAadharUrl() : "")
                .isPanVerified(org.isPanVerified())
                .isTanVerified(org.isTanVerified())
                .isGstVerified(org.isGstVerified())
                .isAadharVerified(org.isAadharVerified())
                .maxEmployees(org.getMaxEmployees())
                .isActive(org.getIsActive())
                .validity(org.getValidity())
