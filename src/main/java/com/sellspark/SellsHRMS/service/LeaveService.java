...
public interface LeaveService {
    ...
    // ============ Utilities ============
    // Double calculateLeaveDays(LocalDate startDate, LocalDate endDate, Long
    // orgId);
    double calculateProratedBalance(LocalDate joiningDate, LeaveType type, OrganisationPolicy policy);

    void validateLeaveAgainstTypePolicy(Employee emp, LeaveType type, LeaveRequestDTO req, double days,
    ...
    // boolean existsOverlappingLeave(Long employeeId, LocalDate startDate,
    // LocalDate endDate);
    ...
    // MonthlySummaryDTO getMonthlyLeaveSummary(Long empId, Integer month, Integer
    // year);
    // LeaveEligibilityDTO checkLeaveEligibility(Long empId, Long leaveTypeId,
    // LocalDate start, LocalDate end);

    // Calendar and history
    // TeamLeaveCalendarDTO getTeamLeaveCalendar(Long orgId, Long managerId, String
    // month, String year);
    // List<LeaveResponseDTO> getEmployeeLeaveHistory(Long empId, Long leaveTypeId,
    // String status, String fy);
