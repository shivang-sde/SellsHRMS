...
public interface AttendanceSummaryRepository
    ...
    List<AttendanceSummary> findByEmployeeIdAndAttendanceDateBetweenOrderByAttendanceDateDesc(
            Long employeeId,
            LocalDate startDate,
            LocalDate endDate);

    List<AttendanceSummary> findByOrganisationIdAndAttendanceDateBetweenOrderByAttendanceDateDesc(
            Long organisationId,
            LocalDate startDate,
            LocalDate endDate);
