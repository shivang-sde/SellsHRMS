$(document).ready(function() {
    ...
    function displayPunchStatus(data) {
        ...
        if (data.punchOut) {
            // Already punched out
            $('#punchStatus').html('<span class="badge bg-secondary fs-6">Punched Out</span>');
            $('#btnPunchIn').hide();
            $('#btnPunchOut').hide();
            ...
            $('#punchStatus').html('<span class="badge bg-success fs-6">Punched In</span>');
            $('#btnPunchIn').hide();
            $('#btnPunchOut').show();
            $('#todayPunchOut').text('--:--');
            $('#workingHours').show();
            
            // Start work hours timer
    ...
    function resetPunchUI() {
        $('#punchStatus').html('<span class="badge bg-secondary fs-6">Not Punched In</span>');
        $('#btnPunchIn').show();
        $('#btnPunchOut').hide();
        $('#todayPunchIn').text('--:--');
        $('#todayPunchOut').text('--:--');
  ...
  if (!dateTimeStr) return '--';
  const date = new Date(dateTimeStr).toLocaleDateString();
