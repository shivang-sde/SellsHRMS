    ...
    <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
        ...
        <div class="row mb-3">
            <div class="col-12">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <h2 class="mb-0">Subordinate Leave Requests</h2>
                        <p class="text-muted mb-0">View and manage leave requests of your team</p>
                    </div>
                    <!-- <div>
        ...
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h5 class="mb-0">Team Leave Records</h5>
        ...
        <div id="toastContainer" class="position-fixed bottom-0 end-0 p-3" style="z-index: 2000"></div>