<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
        <%@ taglib prefix="sec" uri="http://www.springframework.org/security/tags" %>
            ...
            <input type="hidden" id="employeeId" value="${sessionScope.EMP_ID}">
                            ...
                            <div class="col-md-10">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 text-end">
                                        ...
                                        <p class="mb-1"><strong>Designation:</strong> <span id="designation">--</span>
                                        </p>
                        ...
                        <form id="uploadDocForm">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="url" class="form-control" id="docUrl"
                        ...
                        <form id="addBankForm">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="mb-3 form-check">
                                    <input type="checkbox" class="form-check-input" name="isPrimaryAccount"
                                        id="isPrimary">
