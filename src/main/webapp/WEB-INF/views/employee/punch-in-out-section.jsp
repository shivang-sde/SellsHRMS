                                            ...
                                            <div class="flex-grow-1 d-flex flex-column gap-2 mb-2">
                                                <div id="punchedFromDiv">
                                                    ...
                                                    <div class="input-group bg-light rounded-pill p-1 shadow-sm mb-1">
                                                        <span
                                                            class="input-group-text border-0 bg-transparent text-primary">
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-12 col-sm-6 ">
                                        <div class="card summary-card border-0 shadow-sm rounded-4 text-center h-100">
                                            <div class="card-body d-flex flex-column justify-content-center p-3">
                                                <div
                                                    class="icon-shape bg-soft-primary text-primary rounded-circle mx-auto mb-2">
                                                    <i class="fas fa-clock"></i>
                                                </div>
                                                <h6 class="text-muted x-small fw-bold text-uppercase mb-1">Punch In</h6>
                                                <h4 id="todayPunchIn" class="summary-value fw-bold text-dark mb-0">--:--
                                                </h4>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12 col-sm-6 ">
                                        <div class="card summary-card border-0 shadow-sm rounded-4 text-center h-100">
                                            <div class="card-body d-flex flex-column justify-content-center p-3">
                                                <div
                                                    class="icon-shape bg-soft-danger text-danger rounded-circle mx-auto mb-2">
                                                    <i class="fas fa-sign-out-alt"></i>
                                                </div>
                                                <h6 class="text-muted x-small fw-bold text-uppercase mb-1">Punch Out
                                                </h6>
                                                <h4 id="todayPunchOut" class="summary-value fw-bold text-dark mb-0">
                                                    --:--</h4>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12 col-sm-6">
                                        <div class="card summary-card border-0 shadow-sm rounded-4 text-center h-100">
                                            <div class="card-body d-flex flex-column justify-content-center p-3">
                                                <div
                                                    class="icon-shape bg-soft-success text-success rounded-circle mx-auto mb-2">
                                                    <i class="fas fa-hourglass-half"></i>
                                                </div>
                                                <h6 class="text-muted x-small fw-bold text-uppercase mb-1">Total Hours
                                                </h6>
                                                <h4 id="todayTotalHours" class="summary-value fw-bold text-dark mb-0">0h
                                                </h4>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12 col-sm-6">
                                        <div class="card summary-card border-0 shadow-sm rounded-4 text-center h-100">
                                            <div class="card-body d-flex flex-column justify-content-center p-3">
                                                <div
                                                    class="icon-shape bg-soft-info text-info rounded-circle mx-auto mb-2">
                                                    <i class="fas fa-calendar-check"></i>
                                                </div>
                                                <h6 class="text-muted x-small fw-bold text-uppercase mb-1">Attendance
                                                </h6>
                                                <h4 id="monthDaysPresent" class="summary-value fw-bold text-dark mb-0">0
                                                    Days</h4>
                                            </div>
                                        </div>
                                    </div>
