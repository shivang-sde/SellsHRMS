    ...
    <div class="tickets-page">
      ...
      <div class="card border-0 shadow-sm mb-3">
        <div class="card-body">
          <div class="row g-3">
            <div class="col-md-3">
              <input type="text" class="form-control" id="ticketSearchInput" placeholder="Search tickets...">
            </div>
            <div class="col-md-2">
          ...
          <div class="modal-body">
            ...
            <ul class="nav nav-tabs mb-3" id="ticketTabs" role="tablist">
              <li class="nav-item" role="presentation">
                <button class="nav-link active" id="ticketDetailsTab" data-bs-toggle="tab"
                  data-bs-target="#ticketDetails" type="button" role="tab">Details</button>
              </li>
              <li class="nav-item" role="presentation">
                <button class="nav-link" id="ticketAttachmentsTab" data-bs-toggle="tab"
                  data-bs-target="#ticketAttachments" type="button" role="tab">Attachments</button>
              </li>
              <li class="nav-item" role="presentation">
                <button class="nav-link" id="ticketActivityTab" data-bs-toggle="tab" data-bs-target="#ticketActivity"
            ...
            <div class="tab-content">
              ...
              <div class="tab-pane fade" id="ticketAttachments" role="tabpanel">
                <div id="attachmentsUploadArea" class="p-3 border rounded">
                  ...
                  <button type="button" class="btn btn-sm btn-outline-primary" onclick="addAttachmentRow()">+ Add
                    another file</button>
                  <button type="button" class="btn btn-sm btn-primary ms-2"
                    onclick="uploadTicketAttachments(editingTicketId)">Upload All</button>
