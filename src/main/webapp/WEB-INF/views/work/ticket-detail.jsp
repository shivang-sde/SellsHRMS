    ...
    <div class="col-md-8">
      <nav aria-label="breadcrumb" class="mb-2">
        <ol class="breadcrumb small text-uppercase fw-bold ls-1">
          <li class="breadcrumb-item"><a href="#" class="text-decoration-none text-primary">Project Management</a></li>
            ...
            <table class="table table-hover align-middle mb-0" id="tasksTable">
              <thead class="bg-light">
                <tr class="text-muted small fw-bold">
                  <th class="ps-4 py-3">UPDATE TITLE</th>
                  <th>DESCRIPTION</th>
                  <th>AUTHOR</th>
                  <th>DATE</th>
                  <th>FILES</th>
    ...
    <form id="taskForm" class="modal-content border-0 shadow-lg rounded-4">
      ...
      <div class="modal-body py-4">
        ...
        <div class="mb-3">
          ...
          <input type="text" class="form-control rounded-3 py-2" name="title" placeholder="What did you do?" required>
        </div>

        <div class="mb-3">
          <label class="form-label small fw-bold text-muted">Detailed Description</label>
          <textarea class="form-control rounded-3" name="description" rows="4" placeholder="Describe your progress..."
            required></textarea>
        </div>
      ...
      <div class="modal-footer border-0 pt-0">
        ...
        <button type="button" class="btn btn-primary rounded-pill px-4 fw-bold" onclick="saveTicketWorkUpdate()">Save
          Progress</button>
      </div>
    </form>
  </div>
