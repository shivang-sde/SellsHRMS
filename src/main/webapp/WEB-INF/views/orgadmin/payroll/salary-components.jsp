                ...
                <div class="card-body">
                    <div class="row g-3">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" class="form-control" id="searchComponent"
                        ...
                        <form id="componentForm">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" class="form-control" id="componentAbbr" required
                                ...
                                <div class="col-md-6">
                                    <label class="form-label">Calculation Type <span
                                ...
                                <div class="col-12" id="conditionSection">
                                    ...
                                    <div class="col-12 d-none" id="formulaSection">
                                        <div class="d-flex justify-content-between align-items-center mb-1">
                                            <label class="form-label mb-0">Custom Formula <span
                                                    class="text-danger">*</span></label>
                                        </div>
                                        ...
                                        <div class="mb-2 mt-2">
                                            <div class="btn-group btn-group-sm mb-1" role="group">
                                                <button type="button"
                                                    class="btn btn-outline-secondary btn-formula-action"
                                                    data-val="+">+</button>
                                                <button type="button"
                                                    class="btn btn-outline-secondary btn-formula-action"
                                                    data-val="-">-</button>
                                            ...
                                            <div class="btn-group btn-group-sm mb-1 ms-2" role="group">
                                                <button type="button"
                                                    class="btn btn-outline-primary fw-bold btn-formula-action"
                                                    data-val="BASE">BASE Pay</button>
                                                <!-- <button type="button" class="btn btn-outline-primary fw-bold btn-formula-action" data-val="GROSS">GROSS Pay</button> -->
                                                <!-- <button type="button" class="btn btn-outline-info fw-bold btn-formula-action" data-val="WORKING_DAYS">Working Days</button> -->
                                            </div>
                                        </div>

                                        <div class="position-relative">
                                            <textarea class="form-control font-monospace" id="componentFormula" rows="3"
                                                placeholder="e.g., (BASE + DA) * 0.12 or BASE * 0.1"></textarea>
                                            <button type="button"
                                                class="btn btn-sm btn-success position-absolute top-0 end-0 m-2 mt-2 me-2"
                                                id="btnValidateFormula">
                                                <i class="fas fa-check-circle me-1"></i>Test Formula
                                            </button>
                                        </div>
                                        ...
                                        <div class="alert alert-info mt-2 py-2 small">
                                            ...
                                            <small class="text-muted">Formula will auto-format invalid decimal segments
                                                like <em>.5</em> to <em>0.5</em></small>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <small class="form-text text-muted">Include in taxable income
                                            calculation</small>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <small class="form-text text-muted">Round to nearest for easy
                                            calaulation</small>
                                    </div>
