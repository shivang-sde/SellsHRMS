<%@ page contentType="text/html;charset=UTF-8" language="java" %>
    <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
                ...
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        <p class="text-muted mb-0" style="font-size: 0.85rem;">
                            ...
                            The preview uses <strong>sample data</strong> to show how your salary slip will look.
                            Actual employee details, earnings &amp; deductions will be filled in when slips are
                            generated.
                        </p>
                    </div>
                    <div>
                    ...
                    <div class="card-body" style="max-height: 75vh; overflow-y: auto;">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" class="form-control" id="templateName"
                                placeholder="e.g., Default Salary Slip">
                    ...
                    <div class="card-body p-4" style="background-color: #f8f9fa;">
                        <div id="previewContainer" class="bg-white p-4 shadow-sm" style="min-height: 800px;">
                            <div class="text-center text-muted py-5">
                                ...
                                <small class="text-muted">Choose at least organisation and employee fields to get
                                    started</small>
                            </div>
                        </div>
                    </div>
        ...
        <!-- Template List Modal -->
        <div class="modal fade" id="templateListModal" tabindex="-1" aria-labelledby="templateListModalLabel"
            aria-hidden="true">
