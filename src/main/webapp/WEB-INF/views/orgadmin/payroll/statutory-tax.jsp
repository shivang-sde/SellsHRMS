    ...
    <%@ page contentType="text/html;charset=UTF-8" language="java" %>
        <div class="container-fluid mt-3">
            ...
            <ul class="nav nav-tabs " id="payrollTab" role="tablist">
                <li class="nav-item">
                    <a class="nav-link  active" id="statutory-tab" data-bs-toggle="tab" href="#statutory"
                        role="tab">Statutory Components</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link " id="mapping-tab" data-bs-toggle="tab" href="#mapping" role="tab">Statutory
                        Mappings</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link " id="tax-tab" data-bs-toggle="tab" href="#tax" role="tab">Income Tax</a>
                </li>
            </ul>
            ...
            <div class="tab-content mt-3" id="payrollTabContent">
                ...
                <div class="tab-pane fade show active" id="statutory" role="tabpanel">
                    <div class="mb-2">
                        <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#statutoryModal">+ Add
                            Component</button>
                    </div>
                ...
                <div class="tab-pane fade" id="mapping" role="tabpanel">
                    <div class="mb-2">
                        <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#mappingModal">+ Add
                            Mapping</button>
                    </div>
                    <div class="alert alert-info mt-2 py-2 small">
                        <strong>💡 Notice :</strong>
                        <ul class="mb-1 ps-3">
                            <li>By default, every <code>Statutory Component Rule</code> is applied to the employee’s
                                <code>Base Pay</code>.</li>
                            <li>If you want the rule to apply to other salary components (e.g., allowances, bonuses),
                                you need to explicitly map those components here.</li>
                            <li>This ensures statutory calculations (like PF/ESI) are correctly applied across all
                                relevant parts of the salary.</li>
                        </ul>
                        <small class="text-muted">
                            ⚠️ Make sure the components you select are already defined in the salary structure,
                ...
                <div class="tab-pane fade" id="tax" role="tabpanel">
                    <div class="mb-2">
                        <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#taxModal">+ Add Tax
                            Slab</button>
                    </div>
                        ...
                        <form id="statutoryForm">
                            ...
                            <div class="mb-2">
                                ...
                                <div class="table-responsive  payroll-rule-table-wrapper">
                                    <table class="table table-sm payroll-rule-table align-middle"
                                        id="statutoryRuleTable">
                                        <thead>
                                            <tr>
                                                <th>Effective From</th>
                                                <th>Effective To</th>
                                ...
                                <button type="button" class="btn btn-secondary btn-sm" id="addStatutoryRule">+ Add
                                    Rule</button>
                            </div>
                    ...
                    <div class="modal-body">
                        <form id="taxForm">
                            ...
                            <div class="mb-2">
                                ...
                                <button type="button" class="btn btn-secondary btn-sm" id="addTaxRule">+ Add
                                    Rule</button>
                            </div>
                        </form>
                    </div>
