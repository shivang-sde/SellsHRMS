                ...
                <div class="card-body">
                    <div class="row g-3">
                        <div class="col-md-4">
                            ...
                            <input type="text" class="form-control" id="searchStructure"
                        ...
                        <form id="structureForm">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <textarea class="form-control" id="structureDescription" rows="2"
                                        placeholder="Brief description of structure"></textarea>
                                </div>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="text" class="form-control" id="structureCurrency"
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="number" step="0.01" class="form-control" id="leaveEncashmentRate"
