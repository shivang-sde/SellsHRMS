        ...
        <form id="employeeForm" enctype="multipart/form-data">
                ...
                <div class="card-body">
                    <div class="row g-3">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" class="form-control" id="uanNumber" name="uanNumber">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body">
                    ...
                    <div class="row g-3 mb-4">
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" id="localAddressLine1"
                                name="localAddress.addressLine1">
                        </div>
                        <div class="col-md-6">
                            <label class="form-label" for="localAddressLine2">Address Line 2</label>
                            <input type="text" class="form-control" id="localAddressLine2"
                                name="localAddress.addressLine2">
                        </div>
                        <div class="col-md-3">
                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" id="permAddressLine1"
                                name="permanentAddress.addressLine1">
                        </div>
                        <div class="col-md-6">
                            <label class="form-label" for="permAddressLine2">Address Line 2</label>
                            <input type="text" class="form-control" id="permAddressLine2"
            ...
            <div class="card mb-3">
                ...
                <div class="card-body">
                    <div class="row g-3">
                        ...
                        <div class="col-md-4">
                            <label class="form-label" for="dateOfJoining">Date of Joining <span
                                    class="text-danger">*</span></label>
            ...
            <div class="card mb-3">
                ...
                <div class="card-body">
                    <div class="row g-3">
                        <div class="col-md-6">
                            <label class="form-label" for="workEmail">Work Email <span
                                    class="text-danger">*</span></label>
