        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
          ...
          <div class="d-flex gap-2">
            <button class="btn btn-outline-primary"
              onclick="window.location.href='${pageContext.request.contextPath}/org/leave-types'">
              <i class="fa fa-cog me-2"></i>Leave Types
            </button>
            <sec:authorize access="hasAuthority('ORG_ADMIN')">
              <button class="btn btn-outline-secondary"
                onclick="window.location.href='${pageContext.request.contextPath}/org/leave-balances'">
        ...
        <ul class="nav nav-tabs mb-4" id="leaveTabs" role="tablist">
          <li class="nav-item" role="presentation">
            <button class="nav-link active" id="pending-tab" data-bs-toggle="tab" data-bs-target="#pending"
              type="button">
              <i class="fa fa-clock me-2"></i>Pending <span class="badge bg-warning text-dark ms-2"
              ...
              <div class="card-header bg-white border-bottom">
                <div class="d-flex justify-content-between align-items-center">
                  ...
                  <input type="search" class="form-control form-control-sm" style="width: 250px;"
                    placeholder="Search employee..." id="pendingSearch">
                </div>
              </div>
              <div class="card-body">
                ...
                <div class="d-flex justify-content-between align-items-center">
                  ...
                  <div class="d-flex gap-2">
                    <input type="search" class="form-control form-control-sm" style="width: 200px;"
                      placeholder="Search..." id="approvedSearch">
                    <input type="date" class="form-control form-control-sm" style="width: 150px;"
                      id="approvedDateFilter">
                  </div>
                </div>
              </div>
              <div class="card-body">
              ...
              <div class="card-header bg-white border-bottom">
                <div class="d-flex justify-content-between align-items-center">
                  ...
                  <div class="d-flex gap-2">
                    ...
                    <input type="search" class="form-control form-control-sm" style="width: 200px;"
                      placeholder="Search employee..." id="allSearch">
                  </div>
                </div>
              </div>
              <div class="card-body">
              ...
              <div class="modal-body">
                ...
                <div class="mb-3">
                  ...
                  <textarea class="form-control" name="remarks" rows="3"
                    placeholder="Add any approval remarks..."></textarea>
                </div>
              </div>
            ...
            <form id="rejectForm">
              ...
              <div class="modal-body">
                ...
                <div class="mb-3">
                  ...
                  <textarea class="form-control" name="remarks" rows="3"
                    placeholder="Explain why this leave is being rejected..." required></textarea>
                </div>
              </div>
              <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
