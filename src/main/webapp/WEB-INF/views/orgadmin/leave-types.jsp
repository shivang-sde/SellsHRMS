              ...
              <div class="modal-body">
                ...
                <div class="row">
                  ...
                  <div class="col-md-4 mb-3">
                    ...
                    <input type="number" step="0.5" class="form-control" name="accrualRate" id="editAccrualRate"
                      min="0">
                  </div>
                  <div class="col-md-4 mb-3">
                    <label class="form-label">Applicable Gender <span class="text-danger">*</span></label>
                ...
                <div class="row">
                  ...
                  <div class="col-md-6 mb-3">
                    <label class="form-label">Carry Forward Limit</label>
                    <input type="number" class="form-control" name="carryForwardLimit" id="editCarryForwardLimit"
                      min="0">
                  </div>
                  <small class="text-muted d-block" id="carryForwardHint"></small>
                </div>
                ...
                <div class="row">
                  <div class="col-md-6 mb-3">
                    <div class="form-check form-switch">
                      <input class="form-check-input" type="checkbox" name="availableDuringProbation"
                        id="editAvailableDuringProbation">
                      <label class="form-check-label">Available During Probation</label>
                    </div>
                  </div>
                  <div class="col-md-6 mb-3">
                ...
                <div class="row">
                  <div class="col-md-6 mb-3">
                    <div class="form-check form-switch">
                      <input class="form-check-input" type="checkbox" name="visibleToEmployees"
                        id="editVisibleToEmployees">
                      <label class="form-check-label">Visible to Employees</label>
                    </div>
                  </div>
                  <div class="col-md-6 mb-3">
                    <label class="form-label">Max Consecutive Days</label>
                    <input type="number" class="form-control" name="maxConsecutiveDays" id="editMaxConsecutiveDays"
                      min="0">
                  </div>
                </div>
